...
import 'package:tickley/src/widgets/taskWidget.dart';
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(userData.nickname, style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
        ),
        Container(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text('내 Eco 포인트', style: TextStyle(fontSize: 20),),
              Text(userData.point.toString() + 'point', style: TextStyle(fontSize: 20, color: Color(0xff90CA8B), fontWeight: FontWeight.bold),),
            ],
          ),
        )
      ],
