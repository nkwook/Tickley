...
class AllUserPointWidgetState extends State<AllUserPointWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // color: Colors.grey,
      decoration: BoxDecoration(color: const Color(0xffF4F4F5),
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.start, children: <
        Widget>[
          ...
          child: RichText(
            text: TextSpan(style: TextStyle(fontSize:25, fontWeight: FontWeight.w700), children: <TextSpan>[
              TextSpan(text: "지금까지 ", style: TextStyle(color: const Color(0xff929292))),
              TextSpan(
              ...
              TextSpan(
                  text: "소나무"+ (widget.point * 0.01 / 6.6)
                          .toStringAsPrecision(2)
                          .toString() +
                      "그루",
                  style: TextStyle(color: const Color(0xff375854))),
              TextSpan(text: "를 지켰어요!", style: TextStyle(color: const Color(0xff929292))),
            ]),
          )),
          Container(
          alignment: Alignment.centerLeft,
          ...
          // padding: EdgeInsets.only(left: 25),
          child: RichText(
            text: TextSpan(style: TextStyle(fontSize:15, color:const Color(0xff375854)), children: <TextSpan>[
              TextSpan(text: "총 "),
              TextSpan(
